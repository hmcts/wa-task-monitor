...
import static uk.gov.hmcts.reform.wataskmonitor.consumer.ccd.util.PactDslBuilderForCaseDetailsList.buildStartEventForCaseWorkerPactDsl;
...
public class StartEventForCaseWorkerConsumerTest extends CcdConsumerTestBase {
    ...
    public V4Pact startEventForCaseWorker(PactBuilder builder) throws JSONException {
        return builder
            .usingLegacyDsl()
