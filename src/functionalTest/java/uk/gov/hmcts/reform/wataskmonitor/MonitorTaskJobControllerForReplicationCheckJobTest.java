...
public class MonitorTaskJobControllerForReplicationCheckJobTest extends SpringBootFunctionalBaseTest {
    ...
    public void givenMonitorTaskJobRequestShouldReturnStatus200AndExpectedResponse() {
        given()
            ...
            .body(is(expectedResponse.apply(JobName.PERFORM_REPLICATION_CHECK.name())));
    }
