...
public class MonitorTaskJobControllerFoUpdateSearchIndexJobTest extends SpringBootFunctionalBaseTest {
    ...
    public void givenMonitorTaskJobRequestShouldReturnStatus200AndExpectedResponse() {
        given()
            ...
            .body(TestUtility.asJsonString(new MonitorTaskJobRequest(new JobDetails(JobName.UPDATE_SEARCH_INDEX))))
            .when()
            .post("/monitor/tasks/jobs")
            .then()
            .statusCode(HttpStatus.OK.value())
            .body(is(expectedResponse.apply(JobName.UPDATE_SEARCH_INDEX.name())));
    }
