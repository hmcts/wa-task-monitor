...
public class MonitorTaskJobControllerFoDatabaseMaintenanceJobTest extends SpringBootFunctionalBaseTest {
    ...
    public void givenMonitorTaskJobRequestShouldReturnStatus200AndExpectedResponse() {
        given()
            ...
            .body(TestUtility.asJsonString(new MonitorTaskJobRequest(
                new JobDetails(JobName.DATABASE_MAINTENANCE))))
            .when()
            .post("/monitor/tasks/jobs")
            .then()
            .statusCode(HttpStatus.OK.value())
            .body(is(expectedResponse.apply(JobName.DATABASE_MAINTENANCE.name())));
    }
}
