...
class MonitorTaskJobControllerForAdHocCreateTasksTest extends SpringBootFunctionalBaseTest {
    ...
    void givenMonitorTaskJobRequestShouldReturnStatus200AndExpectedResponse() {
        given()
            ...
            .body(TestUtility.asJsonString(new MonitorTaskJobRequest(new JobDetails(AD_HOC_CREATE_TASKS))))
            .when()
