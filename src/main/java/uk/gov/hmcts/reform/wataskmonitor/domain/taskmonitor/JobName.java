...
public enum JobName {
    ...
    RECONFIGURATION, RECONFIGURATION_FAILURES, MAINTENANCE_CAMUNDA_TASK_CLEAN_UP, UPDATE_SEARCH_INDEX,
    CLEANUP_SENSITIVE_LOG_ENTRIES, PERFORM_REPLICATION_CHECK, DATABASE_MAINTENANCE
}
