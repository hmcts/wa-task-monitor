...
class InitiationTaskAttributesMapperTest extends UnitBaseTest {
    ...
    void should_map_task_attributes_from_camunda_task() {
        ...
        camundaVariables.put(CamundaVariableDefinition.TASK_TYPE.value(), new CamundaVariable("testTaskType", "String"));
        camundaVariables.put(CamundaVariableDefinition.TASK_NAME.value(), new CamundaVariable("testTask", "String"));
        camundaVariables.put(CamundaVariableDefinition.ASSIGNEE.value(), new CamundaVariable("testAssignee", "String"));
        camundaVariables.put(CamundaVariableDefinition.DESCRIPTION.value(), new CamundaVariable("testDescription", "String"));
        camundaVariables.put(CamundaVariableDefinition.CREATED.value(), new CamundaVariable("20/06/2022", "String"));
        camundaVariables.put(CamundaVariableDefinition.DUE_DATE.value(), new CamundaVariable("20/07/2022", "String"));
        camundaVariables.put(CamundaVariableDefinition.PRIORITY_DATE.value(), new CamundaVariable("20/07/2022", "String"));


        Map<String, Object> actual = initiationTaskAttributesMapper.mapTaskAttributes(camundaTask, camundaVariables);

        assertEquals(camundaTask.getName(), actual.get(CamundaVariableDefinition.TASK_NAME.value()).toString());
        assertEquals(camundaTask.getAssignee(), actual.get(CamundaVariableDefinition.ASSIGNEE.value()).toString());
